...
Then use `DATABASE_URL=postgresql://syra:syra@localhost:5432/syra` and `REDIS_URL=redis://localhost:6379/0` in backend `.env`.
...
createdb syra
# Or: CREATE USER syra WITH PASSWORD 'syra'; CREATE DATABASE syra OWNER syra;
```
