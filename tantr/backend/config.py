"""
TANTR Backend - Configuration (development / staging / production).
"""
...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql://tantr:tantr@localhost:5432/tantr"
    DB_POOL_SIZE: int = 5
    DB_MAX_OVERFLOW: int = 10
    DB_POOL_PRE_PING: bool = True

    REDIS_URL: str = "redis://localhost:6379/0"
    # Prefer Celery when Redis is reachable; skip the long hang if not
