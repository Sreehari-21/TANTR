"""
TANTR Backend - FastAPI application entry point.
"""
...
logger = logging.getLogger("tantr")
...
async def lifespan(app: FastAPI):
    configure_logging()
    logger.info("Starting TANTR (%s)", settings.ENVIRONMENT)
    ...
    logger.info("TANTR shutdown complete.")
...
@app.get("/health")
def health_check():
    return {"status": "ok", "service": "tantr-backend", "environment": settings.ENVIRONMENT}
