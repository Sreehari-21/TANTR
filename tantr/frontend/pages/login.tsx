  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        localStorage.setItem('tantr_token', access_token);
      } else {
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden border-r border-violet-500/10 p-12 lg:flex">
        <div className="relative">
          ...
          <p className="mt-4 max-w-md text-lg text-slate-400">
            TANTR is your AI mission control — commit code, receive transmissions from your professor, and chart your course through the cosmos.
          </p>
        </div>
      ...
      <div className="relative flex flex-1 items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md animate-slide-up">
          <div className="mb-8 text-center lg:hidden">
            ...
            <h1 className="text-2xl font-bold cosmic-text">TANTR</h1>
